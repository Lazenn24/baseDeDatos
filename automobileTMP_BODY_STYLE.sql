...
LOCK TABLES `BODY_STYLE` WRITE;
/*!40000 ALTER TABLE `BODY_STYLE` DISABLE KEYS */;
INSERT INTO `BODY_STYLE` VALUES (1,'convertible'),(2,'hatchback'),(3,'sedan'),(4,'wagon'),(5,'hardtop');
/*!40000 ALTER TABLE `BODY_STYLE` ENABLE KEYS */;
UNLOCK TABLES;
